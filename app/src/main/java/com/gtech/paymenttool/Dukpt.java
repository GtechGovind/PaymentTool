...
public class Dukpt {
    ...
    public static byte[] GetPinKeyVarFromIPEK(byte[] ksn, byte[] ipek)
    {
        byte[] key;
    ...
    public static String GetPinKeyVarFromIPEK(String ksn, String ipek)
    {
        byte[] bKSN = DES.String2Hex(ksn);
        byte[] bIPEK = DES.String2Hex(ipek);
        byte[] bKey = GetPinKeyVarFromIPEK(bKSN, bIPEK);
        String result = DES.Hex2String(bKey);
    ...
    public static String GetDataKeyVarFromIPEK(String ksn, String ipek)
    {
        byte[] bKSN = DES.String2Hex(ksn);
        byte[] bIPEK = DES.String2Hex(ipek);
        byte[] bKey = GetDataKeyVarFromIPEK(bKSN, bIPEK);
        String result = DES.Hex2String(bKey);
